...
absen = [
    "**Hadir Sayang** 😳",
    "**Hadir Bro Dareen** 😁",
    "**Maaf ka habis nemenin ka Dareen** 🥺",
    "**Maaf ka habis disuruh Tuan Dareen** 🥺🙏🏻",
    "**Hadir Dareen Sayang** 😘",
    "**Hadir Dareen Akuuuuhhh** ☺️",
    "**Hadir Dareen brother Aku** 🥰",
    "**Sokap bet lu**",
    "**Apasi Bawel** 🥰",
]
...
async def naya(naya):
    await naya.reply("**NGAPA LO MANGGIL PEMBUAT GUA KONTOL**😡")


@register(incoming=True, from_users=DEVS, pattern=r"^Adel$")
async def naya(naya):
    await naya.reply("**Adeell Cantiikk Bangeett siihhh**🤩")
